...
import { updateClinicUserService } from "@/services/clinic-users";
...
export default function EditModal({ data, isOpen, onClose }: EditProps) {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: any) =>
      updateClinicUserService(values.id, { ...values }),
    onMutate: async () => {
      setLoading(true);
    },
    ...
    onSuccess: async () => {
      message.success({ content: "Clinic user updated successfully." });
