...
import { updateCmsAdminService } from "@/services/cms-admins";
...
export default function EditModal({ data, isOpen, onClose }: EditProps) {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: any) =>
      updateCmsAdminService(values.id, { ...values }),
    onMutate: async () => {
      setLoading(true);
    },
    ...
    onSuccess: async () => {
      message.success({ content: "CMS Admin updated successfully." });
