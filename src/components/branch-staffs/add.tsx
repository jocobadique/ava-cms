...
import { createClinicBranchStaffService } from "@/services/branch-staffs";
...
export default function AddModal({ isOpen, onClose }: AddProps) {
  ...
  const addMutation = useMutation({
    mutationFn: (values: any) => createClinicBranchStaffService({ ...values }),
    onMutate: async () => {
      setLoading(true);
    },
    ...
    onSuccess: async () => {
      message.success({ content: "Branch staff created successfully." });
