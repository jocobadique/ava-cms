...
import { createClinicBranchAdminService } from "@/services/branch-admins";
...
export default function AddModal({ isOpen, onClose }: AddProps) {
  ...
  const addMutation = useMutation({
    mutationFn: (values: any) => createClinicBranchAdminService({ ...values }),
    onMutate: async () => {
      setLoading(true);
    },
    ...
    onSuccess: async () => {
      message.success({ content: "Branch admin created successfully." });
